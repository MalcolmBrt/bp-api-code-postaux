package nc.opt.bp_api_code_postaux.boitepostale.v2;
...
public class BoitePostaleIntegrationTestV2 {
    ...
    void shouldReturnBoitePostaleForKnownNumBP() {
        String url = "http://localhost:" + port + "/v2/boite-postale?numeroBP=12345";
    ...
    void shouldReturnNotFoundForUnknownNumBP() {
        String url = "http://localhost:" + port + "/v2/boite-postale?numeroBP=99999";
        ResponseEntity<String> response = restTemplate.exchange(url, HttpMethod.GET, null, String.class);
    ...
    void shouldReturnBadRequestForMissingNumBPParam() {
        String url = "http://localhost:" + port + "/v2/boite-postale";
        ResponseEntity<String> response = restTemplate.exchange(url, HttpMethod.GET, null, String.class);
