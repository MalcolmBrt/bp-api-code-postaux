...
public class CodePostalIntegrationTestV1 {
    @LocalServerPort
    private int port;
    ...
    void shouldReturnCodePostalForKnownCommune() {
        String url = "http://localhost:" + port + "/v1/code-postal?nomCommune=NOUMEA";
    ...
    void shouldReturnNotFoundForUnknownCommune() {
        String url = "http://localhost:" + port + "/v1/code-postal?nomCommune=Inconnu";
        ResponseEntity<String> response = restTemplate.exchange(url, HttpMethod.GET, null, String.class);
    ...
    void shouldReturnBadRequestForMissingParams() {
        String url = "http://localhost:" + port + "/v1/code-postal";
        ResponseEntity<String> response = restTemplate.exchange(url, HttpMethod.GET, null, String.class);
